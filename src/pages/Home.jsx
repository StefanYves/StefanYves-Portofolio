    ...
    <div className="min-h-screen  overflow-x-hidden">
      ...
      <div className="flex flex-wrap flex-col md:flex-row items-center justify-center mt-10">
        ...
        <div className="flex-col items-center justify-center m-5">
          ...
          <div className="flex justify-center">
            <a
              href="https://preeminent-kataifi-d56f55.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
              <Fade right>
            ...
            <a
              href="https://github.com/StefanYves/TOP-WeatherApp"
              target="_blank"
              rel="noreferrer"
            >
              <Fade right>
        ...
        <div className="flex-col items-center justify-center m-5">
          ...
          <div className="flex justify-center">
            <a
              href="https://glittery-sopapillas-a15494.netlify.app"
              target="_blank"
              rel="noreferrer"
            >
              <Fade right>
            ...
            <a
              href="https://github.com/StefanYves/TOP-Battleship"
              target="_blank"
              rel="noreferrer"
            >
              <Fade right>
        ...
        <div className="flex-col items-center justify-center m-5">
          ...
          <div className="flex justify-center">
            <a
              href="https://ornate-llama-c19393.netlify.app"
              target="_blank"
              rel="noreferrer"
            >
              <Fade right>
            ...
            <a
              href="https://github.com/StefanYves/CV-Application"
              target="_blank"
              rel="noreferrer"
            >
              <Fade right>
